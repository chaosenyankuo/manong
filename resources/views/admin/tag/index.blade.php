@extends('layouts.admin') @section('title','标签列表') @section('title') 标签列表 @endsection @section('content')
<div class="col-md-12">
    <!-- Advanced Tables -->
    <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="/tag" method="POST">
                                <a href="/tag/create" class="btn btn-waring dropdown-toggle">添加</a>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 377.012px;">标签名</th>
