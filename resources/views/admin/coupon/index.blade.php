@extends('layouts.admin') @section('title','优惠券列表') @section('title') 优惠券列表 @endsection @section('content')
<div class="col-md-12">
    <!-- Advanced Tables -->
    <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="/coupon" method="POST">
                                <a href="/coupon/create" class="btn btn-waring dropdown-toggle">添加</a>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 377.012px;">优惠券名</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 377.012px;">优惠券面值</th>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeA odd">
                                ...
                                <td class=" ">{{$v['price']}}</td>
                                <td class=" ">
                                    <form action="/coupon/{{$v['id']}}" method="POST">
                                        <a href="/coupon/{{$v['id']}}/edit">
