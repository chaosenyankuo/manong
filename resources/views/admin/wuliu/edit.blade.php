@extends('layouts.admin') @section('title') 物流修改 @endsection @section('title','物流修改') @section('content')
<div id="page-inner">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-content">
                    <form class="col s12" method="post" action="/wuliu/{{$wuliu['id']}}" enctype="multipart/form-data">
                       <div class="row" style="margin-left:300px">
                            <div class=" col s6">
                            <label for="first_name">物流公司</label>
                                <input  id="first_name" type="text" class="validate" name="name" value="{{$wuliu['name']}}">
