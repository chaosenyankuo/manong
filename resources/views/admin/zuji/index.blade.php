@extends('layouts.admin') @section('title','足迹列表') @section('title') 足迹列表 @endsection @section('content')
<div class="col-md-12">
    <!-- Advanced Tables -->
    <div class="card">
        <div class="card-content">
            <div class="table-responsive">
                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                    <div class="row">
                        <div class="col-sm-6">
                            <form action="/zuji" method="POST">
                                <a href="/zuji/create" class="btn btn-waring dropdown-toggle">添加</a>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 377.012px;">时间</th>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeA odd">
                                ...
                                <td class=" ">
                                    <form action="/zuji/{{$v['id']}}" method="POST">
